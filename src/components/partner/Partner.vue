<template>
  <div>
    <!-- Banner -->
<section id="banner" style="background-color: 	#00CD66;">
	<div class="inner">
		<h1>欢迎大家来到"蔚士"随笔区,大家可以踊跃投稿<br />
		这是充满自由、绿色的净土</h1>
		<ul class="actions">
			<li><a href="#one" class="button alt scrolly big">继续</a></li>
		</ul>
	</div>
</section>
...
<article id="one" class="post style1">
	<div class="image">
		<img src="../../assets/img/swipe-first.jpg" alt="" data-position="75% center" />
	</div>
	<div class="content">
		<div class="inner">
			<header>
				<h2 style="font-size: 40px;"><a href="">一个充满绿色的地方</a></h2>
				<p class="info">3 天 前 由 <a href="#">Jane Doe</a></p>
			</header>
			<p style="font-family:Lato;font-size: 16px;color:	#548B54">初入村口，绿树掩映，原生态的乡土风貌便扑入眼帘。那绿意盎然、春色清新的空气，和着四月的梧桐花香，沁人心脾，有一种回归自然置身原野的感觉。村后瘦小的山峦，披上了厚重的绿装，苍翠中彰显气势；路两旁是绿油油的麦地和菜园，生机勃勃，一些废弃的旮旯场地周围绿树环绕；田间地头，野草萋萋。不常回家，难得一见这绿色“庄园”，我开始心旷神怡。</p>
			<ul class="actions">
				<li><router-link to="/more/1" class="button alt">阅读更多</router-link></li>
			</ul>
		</div>
		<div class="postnav">
...
<article id="two" class="post invert style1 alt">
	<div class="image">
		<img src="../../assets/img/pic13.jpg" alt="" data-position="10% center" />
	</div>
	<div class="content">
		<div class="inner">
			<header>
				<h2 style="font-size: 40px;"><a href="">诗意、自由</a></h2>
				<p class="info">6 天 前 由 <a href="#">小冬瓜</a></p>
			</header>
			<p style="font-family:Lato;font-size: 16px">悠悠然收回游走的思绪，从小差中走回正道。书本摊开在第一专题上：语言，存在的家园。一旁是一段笔记，“诗意地栖居在大地上。”前景配此句可谓绝妙。然而逐页翻开，便是汉字的“诗意地栖居”了。半分羞愧半分敬佩地批注完林西莉小姐(瑞典)的文章，那活成了古董的汉字在她的笔下仿若又赋予了新生，回溯汉字的历史不难发现每一个字都有它的内涵，古字今释可能是最诗意的吧。</p>
			<ul class="actions">
				<li><a href="" class="button alt">阅读更多</a></li>
			</ul>
		</div>
		<div class="postnav">
...
<article id="three" class="post style2">
	<div class="image">
		<img src="../../assets/img/pic14.jpg" alt="" data-position="80% center" />
	</div>
	<div class="content">
		<div class="inner">
			<header>
				<h2 style="font-size: 40px;"><a href="">环保小感</a></h2>
				<p class="info">7 天 前 由 <a href="#">Deil</a></p>
			</header>
			<p style="font-family:Lato;font-size: 16px;color:	#548B54">从踏入环保这个门槛开始，已经与有了7年的时间，从现场到设计，再从设计到现场，再从现场到市场，这可能是很多环保人走过的路，一路的艰辛，一路的酸甜苦辣，一路走来一路的回味...随着对环保事业认识，使我深深感到这辈子我和环保结缘了，我热爱这份职业，这不仅仅它具有挑战性，更重要是一份责任。</p>
			<ul class="actions">
				<li><a href="" class="button alt">阅读更多</a></li>
			</ul>
		</div>
...
<article id="four" class="post invert style2 alt">
	<div class="image">
		<img src="../../assets/img/pic15.jpg" alt="" data-position="60% center" />
	</div>
	<div class="content">
		<div class="inner">
			<header>
				<h2 style="font-size: 40px;"><a href="">向往自由自在</a></h2>
				<p class="info">11 天 前 由 <a href="#">Jack Liu</a></p>
			</header>
			<p style="font-family:Lato;font-size: 16px;">什么时候我们能够像流浪汉一样自由？什么时候我们可以碎步徜徉于梭罗笔下郁郁葱葱的树林？在那里，简单生活不被视为一种堕落，勤劳的人节制勤劳。在那里，你可以坐在时间的溪水里垂钓天上的星星，不必终日奔波于风尘。看大地寒来暑往，四季消长分明；看种子播撒信念，古树支起苍穹。</p>
			<ul class="actions">
				<li><a href="" class="button alt">阅读更多</a></li>
			</ul>
		</div>
...
<article id="five" class="post style3">
	<div class="image">
		<img src="../../assets/img/pic16.jpg" alt="" data-position="5% center" />
	</div>
	<div class="content">
		<div class="inner">
			<header>
				<h2 style="font-size: 40px;"><a href="">今天你植树了吗？</a></h2>
				<p class="info">13天 前 由 <a href="#">暖冬的风</a></p>
			</header>
			<p style="font-family:Lato;font-size: 16px;color:	#548B54">节日提醒我们保护花草树木，植树造林，保护环境。从古到今，人类就意识到森林绿化的重要性。从生态自然方面来说，它能防风固沙，遮阳挡雨，净化空气等等好处，就像多功能保护伞在呵护我们的地球家园。从经济效益方面看，来自加尔答农业大学德斯教授对一棵50树龄的树叠加计算，它的“GDP”到达196000美元；习总书记说要树立“绿水青山就是金山银山”的强烈意识。而老师从小学到大学就教我们认识植树造林的重要性，如何保护环境了。</p>
			<ul class="actions">
				<li><a href="" class="button alt">阅读更多</a></li>
			</ul>
		</div>
...
<article id="six" class="post invert style3 alt">
	<div class="image">
		<img src="../../assets/img/pic17.jpg" alt="" data-position="80% center" />
	</div>
	<div class="content">
		<div class="inner">
			<header>
				<h2 style="font-size: 40px;"><a href="">散漫的生活态度</a></h2>
				<p class="info">15 天 前 由 <a href="#">Steven</a></p>
			</header>
			<p style="font-family:Lato;font-size: 18px;">夜静静的，人散漫着，不规则地躺在被窝里，思绪飞扬，之前的那杯酒还散发着余温，像是给这个空荡的夜晚增添了几分色彩，伴随着那种淡淡的心情随我四处徘 徊，很久没涂抹些文字了，从幽谷石屋到友情渡假村，再从茶茗香坊到那些千篇一律的诗社，挣脱的脚步进入文苑门口驻足，喜悦的眉稍里，伴随着满是文字流倘的 记忆……</p>
			<ul class="actions">
				<li><a href="" class="button alt">阅读更多</a></li>
			</ul>
		</div>
...
<footer id="footer">
	...
	<div class="copyright">联系方式：weilan@contact.com</div>
</footer>
  </div>
</template>
...
import '../../assets/styles/word-style.css'
